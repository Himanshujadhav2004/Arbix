  ...
  We&apos;re in BETA ⚡ 
          ...
          <div className="flex gap-4 flex-col">
            <h1 className="text-5xl md:text-7xl max-w-4xl text-center font-regular">
              <span className="font-bold text-2xl sm:text-3xl md:text-4xl dark:text-white text-black mb-4">Bridge the Chains. Capture the Gains.</span>
            ...
            Let ArbiX do the trading—seamlessly detect, bridge, and profit across blockchains with zero manual effort
</p>
